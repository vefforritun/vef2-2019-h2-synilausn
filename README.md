# Hópverkefni 2 – sýnilausn

Sýnilausn á hópverkefni 2 í vefforritun 2 árið 2019.

Verkefni búið til með [`create-react-app` með `typescript`](https://facebook.github.io/create-react-app/docs/adding-typescript) ásamt `react-router` og `react-helmet`.

## Uppsetning

Afrita `.env_example` í `.env` og setja slóð á vefþjónustu.
